...
| Panel split | About 48 / 52 | Upper photo and lower design remain balanced; the lower illustration stays contained |
...
- Upper and lower regions share one horizontal axis and are generated as one integrated composition.
...
| Photo share | Default about 48%; adjustable about 40–65% | Photo and illustration must both remain legible |
...
| Swatches | reposition, recolor from photo, hide | If shown, exactly three small solid squares |
